...
class RnnKerasRunner:
    __DEFAULT_FEATURES = ['score', 'winrate', 'utility', 'stddev', 'selfplay', 'dist_from_prev', 'winrate_sqr',
                          'score_sqr', 'dist_more_5']
...
class TwoModelsCombiner:
    ...
    def predict(self, data):
        data_W = data[data['color'] == get_features.int_from_player('W')]
        data_B = data[data['color'] == get_features.int_from_player('B')]
